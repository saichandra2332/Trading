...
// import { FiUser, FiMail, FiCreditCard, FiHash, FiAward, FiShield } from "react-icons/fi";
...
export default function AccountPage({ account, wallet }) {
  // Format investment nicely with commas
  ...
  const stats = [
    { icon: <FiUser size={20} />, label: "Name", value: account?.name || "Loading...", color: "#6366f1" },
    { icon: <FiHash size={20} />, label: "User ID", value: account?.user_id || "0", color: "#10b981" },
    { icon: <FiMail size={20} />, label: "Email", value: account?.email || "0", color: "#f59e0b" },
    { icon: <FiCreditCard size={20} />, label: "Broker", value: account?.broker || "0", color: "#3b82f6" },
