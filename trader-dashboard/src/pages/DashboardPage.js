...
export default function DashboardPage() {
  ...
  const fundsBody = (
    <div style={modalContentStyle}>
      <div style={largeMetricStyle}>
        ...
        <span style={{ ...metricValueStyle, fontSize: "2.2rem" }}>
          ₹{summary.funds?.toLocaleString() ?? 0}
        </span>
      </div>
      <div style={dividerStyle} />
  ...
  const pnlBody = (
    <div style={modalContentStyle}>
      <div style={largeMetricStyle}>
        <span style={metricLabelStyle}>Today's Profit & Loss</span>
        <span style={{ 
          ...metricValueStyle, 
          fontSize: "2.2rem",
          color: summary.pnlToday >= 0 ? "#16a34a" : "#dc2626"
        }}>
      ...
      <div style={metricRowStyle}>
        <div style={metricItemStyle}>
          <span style={metricLabelStyle}>Intraday P&L</span>
...
/* ---------- Resuable SectionTable component ---------- */
      ...
      <div style={tableWrapperStyle}>
        <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "0" }}>
          ...
          <tbody>
            {rows.length === 0 ? (
              <tr>
                <td colSpan={headers.length} style={emptyCellStyle}>No Data Available</td>
              </tr>
            ) : rows.map((cells, rIdx) => (
              <tr
                key={rIdx}
                    ...
                    style={{
                      ...
                      color:
                        (title === "Active Positions" && cIdx === 4)
                          ? (typeof c === 'number' ? (c >= 0 ? "#16a34a" : "#dc2626") : "#374151")
                          : undefined,
                      fontWeight: 
                        (title === "Active Positions" && cIdx === 4) ? "600" : "normal"
                    }}
                  >
                    {c}
                  </td>
...
// ======= All your styles below (copy as is from your previous code) =======
